...
var JwtStrategy = exports.JwtStrategy = function () {
    ...
    var _classThis;
    var JwtStrategy = _classThis = (function (_super) {
        __extends(JwtStrategy_1, _super);
        function JwtStrategy_1(authService, configService) {
            var _this = _super.call(this, {
                jwtFromRequest: passport_jwt_1.ExtractJwt.fromAuthHeaderAsBearerToken(),
                ignoreExpiration: false,
                secretOrKey: configService.get('JWT_SECRET') || 'recipe-ai-ultra-secure-key-2024!@#$',
            }) || this;
            _this.authService = authService;
            _this.configService = configService;
            console.log('🔑 JWT Strategy initialized with secret:', configService.get('JWT_SECRET') ? 'FROM_ENV' : 'DEFAULT');
            return _this;
        }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4, this.authService.validateUserById(payload.sub)];
                        case 1:
                            user = _a.sent();
                            if (!user) {
                            ...
                            return [2, { id: payload.sub, email: payload.email }];
                    }
                });
            });
        };
